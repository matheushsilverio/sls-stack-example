...
!(function (e, n) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(n)
    : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).Flicking = n());
})(this, function () {
  'use strict';
  var e = function (n, t) {
    return (
        ...
        return (function (o) {
          ...
          for (; a; )
            try {
              if (
                ((t = 1),
                i && (r = 2 & o[0] ? i.return : o[0] ? i.throw || ((r = i.return) && r.call(i), 0) : i.next) && !(r = r.call(i, o[1])).done)
              )
                return r;
  ...
  function a(e, n) {
    ...
    var i,
      ...
      a = [];
    try {
      for (; (void 0 === n || n-- > 0) && !(i = o.next()).done; ) a.push(i.value);
    } catch (e) {
      r = { error: e };
    } finally {
      try {
  ...
  var h = function (e) {
    ...
    f = (function () {
      function e(e, n) {
        ...
        if (((this._canceled = !1), n))
          try {
            for (var r = u(Object.keys(n)), o = r.next(); !o.done; o = r.next()) {
              var a = o.value;
              this[a] = n[a];
            }
          } catch (e) {
      ...
      return (
        ...
        (n.on = function (e, n) {
          ...
          if ('string' == typeof e && 'function' == typeof n) {
            ...
            h(r) && ((this._eventHandler[e] = []), (r = this._eventHandler[e])), r.push(n);
          }
          return this;
        }),
        (n.off = function (e, n) {
    ...
    b = 'This module is not attached to the Flicking instance. "init()" should be called first.',
    y = function (e, n) {
      return 'Option "' + e + '" is not in correct format, given: ' + n;
    },
    E = function (e, n, t) {
      return 'Index "' + e + '" is out of range: should be between ' + n + ' and ' + t + '.';
    },
    P = function (e) {
      return 'Position "' + e + '" is not reachable.';
    },
    x = 'Browser does not support CSS transform.',
    O = 'Event stop() is called by user.',
    w = 'Animation is interrupted by user input.',
    T = 'Animation is already playing.',
    R = 'This behavior is not allowed in the frameworks like React, Vue, or Angular.',
    I = 'Flicking is not initialized yet, call init() first.',
    A = {
      READY: 'ready',
    ...
    C = { PREV: 'prev', CENTER: 'center', NEXT: 'next' },
    k = { PREV: 'PREV', NEXT: 'NEXT', NONE: null },
    M = { SNAP: 'snap', FREE_SCROLL: 'freeScroll', STRICT: 'strict' },
    S = { VERTICAL: 'vertical', HIDDEN: 'flicking-hidden', DEFAULT_VIRTUAL: 'flicking-panel' },
    N = { LINEAR: 'linear', BOUND: 'bound' },
    D = { __proto__: null, EVENTS: A, ALIGN: C, DIRECTION: k, MOVE_TYPE: M, CLASS: S, CIRCULAR_FALLBACK: N, ERROR_CODE: p },
    j = function (e) {
      for (var n = [], t = 1; t < arguments.length; t++) n[t - 1] = arguments[t];
      return (
    ...
    L = function (e, n) {
      ...
      if (Q(e)) {
        ...
        if (!i) throw new le(_(e), p.ELEMENT_NOT_FOUND);
        t = i;
      } else e && e.nodeType === Node.ELEMENT_NODE && (t = e);
      if (!t) throw new le(v(e, ['HTMLElement', 'string']), p.WRONG_TYPE);
      return t;
    },
    z = function (e, n) {
      if (null == e) throw new le(m(e, n), p.VAL_MUST_NOT_NULL);
    },
    V = function (e, n, t) {
      return Math.max(Math.min(e, t), n);
    },
    H = function (e) {
      if (!e) throw new le(b, p.NOT_ATTACHED_TO_FLICKING);
      return e;
    },
    F = function (e) {
      return [].slice.call(e);
      ...
      if (Q(e))
        switch (e) {
          ...
          case C.NEXT:
            ...
            break;
          default:
            if (null == (t = X(e, n))) throw new le(y('align', e), p.WRONG_OPTION);
        }
      else t = e;
      return t;
    },
    G = function (e, n) {
      ...
      return t.map(function (n) {
        if (null == n) throw new le(y('bounce', e), p.WRONG_OPTION);
        return n;
      });
    },
    X = function (e, n) {
    ...
    Y = function (e) {
      ...
      for (var t = { percentage: 0, absolute: 0 }, i = 0, r = n.exec(e); null != r; ) {
        var o = r[1],
          a = r[2],
          s = r[3],
          u = parseFloat(a);
        ...
        var l = '+' === o ? 1 : -1;
        '%' === s ? (t.percentage += l * (u / 100)) : (t.absolute += l * u), ++i, (r = n.exec(e));
      }
      return 0 === i ? null : t;
    },
    W = function (e) {
    ...
    U = function (e, n) {
      return e === n ? k.NONE : e < n ? k.NEXT : k.PREV;
    },
    q = function (e) {
      Array.isArray(e) || (e = [e]);
      var n = [];
      return (
        e.forEach(function (e) {
          if (Q(e)) {
            ...
            for (t.innerHTML = e, n.push.apply(n, s(F(t.children))); t.firstChild; ) t.removeChild(t.firstChild);
          } else {
            if (!e || e.nodeType !== Node.ELEMENT_NODE) throw new le(v(e, ['HTMLElement', 'string']), p.WRONG_TYPE);
            n.push(e);
          }
        }),
        n
    ...
    ie = function (e, n) {
      var t = n.width,
        i = n.height;
      null != t && (Q(t) ? (e.style.width = t) : (e.style.width = t + 'px')),
        null != i && (Q(i) ? (e.style.height = i) : (e.style.height = i + 'px'));
    },
    re = function (e, n, t) {
      return e >= n && e <= t;
    },
    oe = function (e, n) {
      return e >= n ? e % n : e < 0 ? Z(((e + 1) % n) - 1, n) : e;
    },
    ae = function (e) {
    ...
    ue = {
      ...
      checkExistence: z,
      clamp: V,
      getFlickingAttached: H,
      toArray: F,
      parseAlign: B,
      parseBounce: G,
      parseArithmeticSize: X,
      parseArithmeticExpression: Y,
    ...
    le = (function (e) {
      function t(n, i) {
        ...
        return se(r, t.prototype), (r.name = 'FlickingError'), (r.code = i), r;
      }
      return n(t, e), t;
    })(Error),
    ce = (function () {
      ...
      return (
        ...
        (n.setSize = function (e) {
          ...
          if (null != n)
            if (Q(n)) i.style.width = n;
            else {
              var a = o ? n + r.left + r.right : n;
              i.style.width = a + 'px';
            }
          if (null != t)
            if (Q(t)) i.style.height = t;
            else {
        ...
        (n.resize = function () {
          ...
          (this._width = e.clientWidth),
            ...
            (this._padding = {
              ...
              right: n.paddingRight ? parseFloat(n.paddingRight) : 0,
              top: n.paddingTop ? parseFloat(n.paddingTop) : 0,
              bottom: n.paddingBottom ? parseFloat(n.paddingBottom) : 0,
            }),
            (this._isBorderBoxSizing = 'border-box' === n.boxSizing);
        }),
        e
      );
    })(),
        ...
        (this._onResize = function () {
          ...
          n <= 0
            ...
            : (t._maxResizeDebounceTimer <= 0 &&
                i > 0 &&
                i >= n &&
                (t._maxResizeDebounceTimer = window.setTimeout(t._doScheduledResize, i)),
              t._resizeTimer > 0 && (clearTimeout(t._resizeTimer), (t._resizeTimer = 0)),
              (t._resizeTimer = window.setTimeout(t._doScheduledResize, n)));
        }),
      ...
      return (
        ...
        (n.enable = function () {
          var e = this._flicking,
            n = e.viewport;
          if ((this._enabled && this.disable(), e.useResizeObserver && window.ResizeObserver)) {
            var t = 0 !== n.width || 0 !== n.height ? new ResizeObserver(this._skipFirstResize) : new ResizeObserver(this._onResize);
            t.observe(e.viewport.element), (this._resizeObserver = t);
        ...
        (n.disable = function () {
          ...
          return (
            e ? (e.disconnect(), (this._resizeObserver = null)) : window.removeEventListener('resize', this._onResize),
            (this._enabled = !1),
            this
          );
        }),
    ...
    fe = (function () {
      ...
      return (
        ...
        (n.show = function (e) {
          var n = this.element,
            t = e.camera.element;
          n.parentElement !== t && (t.appendChild(n), (this._rendered = !0));
        }),
        (n.hide = function (e) {
          var n = this.element,
            t = e.camera.element;
          n.parentElement === t && (t.removeChild(n), (this._rendered = !1));
        }),
        e
      );
    })(),
    ...
    ge = (function () {
      function e(e, n) {
        ...
        (this._flicking = e),
          (this._renderPanel =
            null !== (t = null == n ? void 0 : n.renderPanel) && void 0 !== t
              ? t
              : function () {
                  return '';
                }),
          (this._initialPanelCount = null !== (i = null == n ? void 0 : n.initialPanelCount) && void 0 !== i ? i : -1),
          (this._cache = null !== (r = null == n ? void 0 : n.cache) && void 0 !== r && r),
          (this._panelClass = null !== (o = null == n ? void 0 : n.panelClass) && void 0 !== o ? o : S.DEFAULT_VIRTUAL),
          (this._elements = []);
      }
      var n = e.prototype;
      return (
        ...
        Object.defineProperty(n, 'renderPanel', {
          ...
          set: function (e) {
            (this._renderPanel = e),
              this._flicking.renderer.panels.forEach(function (e) {
        ...
        (n.init = function () {
          var e = this._flicking;
          if (e.virtualEnabled) {
            e.externalRenderer || e.renderExternal || this._initVirtualElements();
        ...
        (n.insert = function (e, n) {
          return (
            void 0 === n && (n = 1), n <= 0 ? [] : this._flicking.renderer.batchInsert({ index: e, elements: ae(n), hasDOMInElements: !1 })
          );
        }),
        (n.remove = function (e, n) {
          return n <= 0 ? [] : this._flicking.renderer.batchRemove({ index: e, deleteCount: n, hasDOMInElements: !1 });
        }),
        (n._initVirtualElements = function () {
          ...
          ae(i + 1)
            .map(function (n) {
              var t = document.createElement('div');
              return (t.className = e._panelClass), (t.dataset.elementIndex = n.toString()), t;
            })
            .forEach(function (e) {
              r.appendChild(e);
            }),
  ...
  function ye(e, n) {
    ...
    return (
      pe(e, function (e) {
        var i = Ee(n, e);
        return !!i && ((t.brand = e.id), (t.version = e.versionAlias || i.version), '-1' !== t.version);
      }),
      t
    );
  }
  function Ee(e, n) {
    return ve(e, function (e) {
      var t = e.brand;
      return _e('' + n.test, t.toLowerCase());
    });
  }
  var Pe = [
    ...
    xe = [
      { test: '(?=.*applewebkit/(53[0-7]|5[0-2]|[0-4]))(?=.*\\schrome)', id: 'chrome', versionTest: 'chrome' },
      { test: 'chromium', id: 'chrome' },
      { test: 'whale', id: 'chrome', versionAlias: '-1', brand: !0 },
    ],
    Oe = [{ test: 'applewebkit', id: 'webkit', versionTest: 'applewebkit|safari' }],
    we = [
  ...
  function Re(e) {
    ...
    if (((i.chromium = !!h.preset), (i.chromiumVersion = h.version), !i.chromium)) {
      var f = be(Oe, n);
      (i.webkit = !!f.preset), (i.webkitVersion = f.version);
    }
    return (
      l && ((r.name = l.id), (r.version = c), (r.majorVersion = parseInt(c, 10))),
      a && ((i.name = a.id), (i.version = s), i.webview && 'ios' === r.name && 'safari' !== i.name && (i.webview = !1)),
  ...
  function Ae(e, n) {
    ...
    Ie(e, n), (e.prototype = null === n ? Object.create(n) : ((t.prototype = n.prototype), new t()));
  }
  var Ce,
    ke = function () {
      return (
  ...
  Ce = 'undefined' == typeof window ? { navigator: { userAgent: '' } } : window;
  var Me,
    Se = 24,
    Ne = 'left',
    De = 'right',
      ...
      'safari' ===
        ...
        (function () {
          ...
          ? (function (e) {
              ...
              var s = ye(xe, t);
              if (((o.chromium = !!s.brand), (o.chromiumVersion = s.version), !o.chromium)) {
                var u = ye(Oe, t);
              ...
              if (e) {
                ...
                (a.name = c ? c.id : l), (a.version = e.platformVersion);
              }
              var h = ye(Pe, t);
              return (
                h.brand && ((o.name = h.brand), (o.version = e ? e.uaFullVersion : h.version)),
                'Linux armv8l' === navigator.platform ? (a.name = 'android') : o.webkit && (a.name = i ? 'ios' : 'mac'),
                'ios' === a.name && o.webview && (o.version = '-1'),
                (a.version = me(a.version)),
                (o.version = me(o.version)),
    ...
    Ve = { 'user-select': 'none', '-webkit-user-drag': 'none' },
    He = function (e) {
    ...
    Fe = function (e, n) {
      ...
      if ((void 0 === n && (n = !1), 'string' == typeof e)) {
        if (e.match(/^<([a-z]+)\s*([^>]*)>/)) {
          ...
          (i.innerHTML = e), (t = He(i.childNodes));
        } else t = He(document.querySelectorAll(e));
        n || (t = t.length >= 1 ? t[0] : void 0);
      } else
        e === Ce
          ? (t = e)
          : !e.nodeName || (1 !== e.nodeType && 9 !== e.nodeType)
          ? ('jQuery' in Ce && e instanceof jQuery) || e.constructor.prototype.jquery
    ...
    Be = Ce.requestAnimationFrame || Ce.webkitRequestAnimationFrame,
    Ge = Ce.cancelAnimationFrame || Ce.webkitCancelAnimationFrame;
  if (Be && !Ge) {
    var Xe = {},
      Ye = Be;
    (Be = function (e) {
    ...
    (Be && Ge) ||
      ((Be = function (e) {
        return Ce.setTimeout(function () {
          e((Ce.performance && Ce.performance.now && Ce.performance.now()) || new Date().getTime());
        }, 16);
      }),
      (Ge = Ce.clearTimeout));
  var We,
    ...
    Qe = {},
    Je = function (e, n) {
      return Qe[n] || (Qe[n] = nn(n)), Qe[n](e);
    },
    $e = function (e, n) {
      return e && n
        ? Ue(e, function (e, t) {
            return Je(e, 'number' == typeof n ? n : n[t]);
          })
        : e;
    },
    en = function (e) {
      ...
      var n = '' + e;
      if (n.indexOf('e') >= 0) {
        for (var t = 0, i = 1; Math.round(e * i) / i !== e; ) (i *= 10), t++;
        return t;
      }
      return n.indexOf('.') >= 0 ? n.length - n.indexOf('.') - 1 : 0;
    },
    nn = function (e) {
      var n = e < 1 ? Math.pow(10, en(e)) : 1;
      return function (t) {
    ...
    tn = (function () {
      ...
      return (
        ...
        (n.triggerRelease = function (e) {
          ...
          (e.destPos = t),
            (e.depaPos = i),
            (e.setTo = this._createUserControll(e.destPos, e.duration)),
            this._axes.trigger(new g('release', ke(ke({}, e), { bounceRatio: this._getBounceRatio(t) })));
        }),
        (n.triggerChange = function (e, n, t, i) {
          ...
          var r = this.animationManager,
            ...
            l = s.roundDepa,
            c = o.moveTo(u, l),
            h = (null == t ? void 0 : t.event) || (null == a ? void 0 : a.event) || null,
            f = {
              pos: c.pos,
              delta: c.delta,
              ...
              inputEvent: h,
              isTrusted: !!h,
              input: (null == t ? void 0 : t.input) || (null == a ? void 0 : a.input) || null,
              set: h ? this._createUserControll(c.pos) : function () {},
            },
            d = new g('change', f);
          return this._axes.trigger(d), h && o.set(f.set().destPos), !d.isCanceled();
        }),
        (n.triggerAnimationStart = function (e) {
          var n = this._getRoundPos(e.destPos, e.depaPos),
            t = n.roundPos,
            i = n.roundDepa;
          (e.destPos = t), (e.depaPos = i), (e.setTo = this._createUserControll(e.destPos, e.duration));
          var r = new g('animationStart', e);
          return this._axes.trigger(r), !r.isCanceled();
        }),
        (n.triggerAnimationEnd = function (e) {
          void 0 === e && (e = !1), this._axes.trigger(new g('animationEnd', { isTrusted: e }));
        }),
        (n.triggerFinish = function (e) {
          void 0 === e && (e = !1), this._axes.trigger(new g('finish', { isTrusted: e }));
        }),
        ...
        (n._createUserControll = function (e, n) {
          void 0 === n && (n = 0);
          var t = { destPos: ke({}, e), duration: n };
          return function (e, n) {
            return e && (t.destPos = ke({}, e)), void 0 !== n && (t.duration = n), t;
          };
        }),
        (n._getRoundPos = function (e, n) {
          var t = this._axes.options.round;
          return { roundPos: $e(e, t), roundDepa: $e(n, t) };
        }),
    ...
    on = function (e, n, t, i) {
      var r = e,
        o = [t[0] ? n[0] : i ? n[0] - i[0] : n[0], t[1] ? n[1] : i ? n[1] + i[1] : n[1]];
    ...
    un = function (e, n, t) {
      var i = e,
        ...
        o = n[1],
        a = o - r;
      return t[1] && e > o && (i = ((i - o) % a) + r), t[0] && e < r && (i = ((i - r) % a) + o), i;
    },
    ln = (function () {
      function e(e) {
        var n = this;
        (this._axis = e),
          ...
          (this._pos = Object.keys(this._axis).reduce(function (e, t) {
      ...
      return (
        (n.getDelta = function (e, n) {
          var t = this.get(e);
          return Ue(this.get(n), function (e, n) {
            return e - t[n];
          });
        }),
        (n.get = function (e) {
        ...
        (n.moveTo = function (e, n) {
          ...
          var t = Ue(this._pos, function (t, i) {
            return i in e && i in n ? e[i] - n[i] : 0;
          });
          return (
            this.set(
              this.map(e, function (e, n) {
                return n ? un(e, n.range, n.circular) : 0;
              }),
            ),
        ...
        (n.set = function (e) {
          for (var n in e) n && n in this._pos && (this._pos[n] = e[n]);
        }),
        ...
        (n.isOutside = function (e) {
          return !this.every(e ? this.get(e) : this._pos, function (e, n) {
            return !an(e, n.range);
          });
        }),
        ...
        (n._complementOptions = function () {
          ...
          Object.keys(this._axis).forEach(function (n) {
            (e._axis[n] = ke({ range: [0, 100], bounce: [0, 0], circular: [!1, !1] }, e._axis[n])),
              ['bounce', 'circular'].forEach(function (t) {
                var i = e._axis,
                  r = i[n][t];
                /string|number|boolean/.test(typeof r) && (i[n][t] = [r, r]);
              });
          });
        }),
        e
    ...
    cn = 'ontouchstart' in Ce,
    hn = 'PointerEvent' in Ce,
    fn = hn || 'MSPointerEvent' in Ce,
    dn = (function () {
      function e() {
        var e = this;
        this._stopContextMenu = function (n) {
          n.preventDefault(), Ce.removeEventListener('contextmenu', e._stopContextMenu);
        };
      }
      var n = e.prototype;
      return (
        (n.extendEvent = function (e) {
          var n,
            ...
            u = r ? ((t = o.x - r.center.x), (i = o.y - r.center.y), (180 * Math.atan2(i, t)) / Math.PI) : 0,
          ...
          return (
            (!d || p >= 16) &&
              (d && ((v = (n = [(l - d.deltaX) / p, (c - d.deltaY) / p])[0]), (_ = n[1])),
              (this._latestInterval = { timestamp: g, deltaX: l, deltaY: c })),
            {
              srcEvent: e,
              scale: s,
              angle: u,
        ...
        (n._getButton = function (e) {
          var n = { 1: Ne, 2: De, 4: je },
            t = this._isTouchEvent(e) ? Ne : n[e.buttons];
          return t || null;
        }),
        ...
        (n._preventMouseButton = function (e, n) {
          n === De ? Ce.addEventListener('contextmenu', this._stopContextMenu) : n === je && e.preventDefault();
        }),
        e
      );
    })(),
    gn = (function (e) {
      function n() {
        ...
        return (n.start = ['mousedown']), (n.move = ['mousemove']), (n.end = ['mouseup']), n;
      }
      Ae(n, e);
      var t = n.prototype;
      return (
        (t.onEventStart = function (e, n) {
          ...
          return n && !this._isValidButton(t, n) ? null : (this._preventMouseButton(e, t), this.extendEvent(e));
        }),
        (t.onEventMove = function (e, n) {
          return n && !this._isValidButton(this._getButton(e), n) ? null : this.extendEvent(e);
        }),
        ...
        (t._getMovement = function (e) {
          ...
          return { x: e.clientX - n.clientX, y: e.clientY - n.clientY };
        }),
        n
      );
    })(dn),
    pn = (function (e) {
      function n() {
        var n = (null !== e && e.apply(this, arguments)) || this;
        return (n.start = ['touchstart']), (n.move = ['touchmove']), (n.end = ['touchend', 'touchcancel']), n;
      }
      Ae(n, e);
      var t = n.prototype;
      return (
        ...
        (t._getScale = function (e) {
          return 2 !== e.touches.length || this._baseTouches.length < 2
            ? null
            : this._getDistance(e.touches[0], e.touches[1]) / this._getDistance(this._baseTouches[0], this._baseTouches[1]);
        }),
        (t._getCenter = function (e) {
        ...
        (t._getMovement = function (e) {
          ...
          return e.touches[0].identifier !== n.touches[0].identifier
            ? { x: 0, y: 0 }
            : { x: e.touches[0].clientX - n.touches[0].clientX, y: e.touches[0].clientY - n.touches[0].clientY };
        }),
        n
      );
    })(dn),
    vn = (function (e) {
      function n() {
        var n = (null !== e && e.apply(this, arguments)) || this;
        return (
          (n.start = hn ? ['pointerdown'] : ['MSPointerDown']),
          (n.move = hn ? ['pointermove'] : ['MSPointerMove']),
          (n.end = hn ? ['pointerup', 'pointercancel'] : ['MSPointerUp', 'MSPointerCancel']),
          (n._firstInputs = []),
          (n._recentInputs = []),
          n
        );
      ...
      return (
        (t.onEventStart = function (e, n) {
          ...
          return n && !this._isValidButton(t, n)
            ? null
            : (this._preventMouseButton(e, t), this._updatePointerEvent(e), this.extendEvent(e));
        }),
        (t.onEventMove = function (e, n) {
          return n && !this._isValidButton(this._getButton(e), n) ? null : (this._updatePointerEvent(e), this.extendEvent(e));
        }),
        (t.onEventEnd = function (e) {
        ...
        (t._getMovement = function (e) {
          var n = this.prevEvent.srcEvent;
          return e.pointerId !== n.pointerId ? { x: 0, y: 0 } : { x: e.clientX - n.clientX, y: e.clientY - n.clientY };
        }),
        (t._updatePointerEvent = function (e) {
          var n = this,
            t = !1;
          this._recentInputs.forEach(function (i, r) {
            i.pointerId === e.pointerId && ((t = !0), (n._recentInputs[r] = e));
          }),
            t || (this._firstInputs.push(e), this._recentInputs.push(e));
        }),
      ...
      return (
        (t.onEventStart = function (e, n) {
          ...
          return (
            ...
            n && !this._isValidButton(t, n) ? null : (this._preventMouseButton(e, t), this.extendEvent(e))
          );
        }),
        (t.onEventMove = function (e, n) {
          return n && !this._isValidButton(this._getButton(e), n) ? null : this.extendEvent(e);
        ...
        (t._getCenter = function (e) {
          return this._isTouchEvent(e) ? { x: e.touches[0].clientX, y: e.touches[0].clientY } : { x: e.clientX, y: e.clientY };
        }),
        (t._getMovement = function (e) {
          var n = this,
            t = [e, this.prevEvent.srcEvent].map(function (e) {
              return n._isTouchEvent(e)
                ? { id: e.touches[0].identifier, x: e.touches[0].clientX, y: e.touches[0].clientY }
                : { id: null, x: e.clientX, y: e.clientY };
            }),
            i = t[0],
            r = t[1];
          return i.id === r.id ? { x: i.x - r.x, y: i.y - r.y } : { x: 0, y: 0 };
        }),
        n
      );
    })(dn),
      ...
      return (
        ...
        (n.hold = function (e, n) {
          if (!this._interruptManager.isInterrupted() && e.axes.length) {
            ...
            (this._isStopped = !1),
              ...
              this._moveDistance || this._eventManager.hold(this._axisManager.get(), t),
              (this._isOutside = this._axisManager.isOutside(e.axes)),
              (this._moveDistance = this._axisManager.get(e.axes));
          }
        }),
        (n.change = function (e, n, t, i) {
          if (
            ...
            if (!r.__childrenAxesAlreadyChanged) {
              var o,
                a = this._moveDistance || this._axisManager.get(e.axes);
              (o = Ue(a, function (e, n) {
                return e + (t[n] || 0);
              })),
                this._moveDistance &&
                  (this._moveDistance = this._axisManager.map(o, function (e, n) {
                    var t = n.circular,
                      i = n.range;
                    return t && (t[0] || t[1]) ? un(e, i, t) : e;
                  })),
                this._isOutside &&
                ...
                (a = this._atOutside(a)),
                (o = this._atOutside(o)),
                (this.options.nested && this._isEndofAxis(t, a, o)) || (r.__childrenAxesAlreadyChanged = !0);
              var s = { input: e, event: n };
              if (i) {
                var u = this._animationManager.getDuration(o, a);
                this._animationManager.animateTo(o, u, s);
              } else {
                !this._eventManager.triggerChange(o, a, s, !0) &&
                  ((this._isStopped = !0), (this._moveDistance = null), this._animationManager.finish(!1));
              }
            }
          }
        }),
        (n.release = function (e, n, t, i) {
          if (!this._isStopped && this._interruptManager.isInterrupting() && this._moveDistance) {
            ...
            var o = this._axisManager.get(e.axes),
              ...
              l = this._axisManager.get(
                this._axisManager.map(u, function (e, n, t) {
                  return n.circular && (n.circular[0] || n.circular[1]) ? o[t] + e : on(o[t] + e, n.range, n.circular, n.bounce);
                }),
              );
            ...
            this._eventManager.triggerRelease(h), (this._moveDistance = null);
            var f = this._animationManager.getUserControl(h),
              d = Ke(f.destPos, a),
              g = { input: e, event: n };
            d || 0 === f.duration
              ? (d || this._eventManager.triggerChange(f.destPos, a, g, !0),
                this._interruptManager.setInterrupt(!1),
                this._axisManager.isOutside() ? this._animationManager.restore(g) : this._eventManager.triggerFinish(!0))
              : this._animationManager.animateTo(f.destPos, f.duration, g);
          }
        }),
          ...
          return this._isOutside
            ...
            : this._axisManager.map(e, function (e, t) {
                ...
                return a && (a[0] || a[1])
                  ? e
                  : e < i
                  ? i - n._animationManager.interpolate(i - e, o[0])
                  : e > r
                  ? r + n._animationManager.interpolate(e - r, o[1])
                  : e;
              });
        }),
        (n._isEndofAxis = function (e, n, t) {
          return this._axisManager.every(n, function (i, r, o) {
            return (
              ...
              (n[o] === t[o] &&
                (function (e, n, t, i) {
                  return (!i[0] && e === n[0] - t[0]) || (!i[1] && e === n[1] + t[1]);
    ...
    En = (function () {
      ...
      return (
        (n.getDuration = function (e, n, t) {
          ...
          return yn(i, this._options.minimumDuration, this._options.maximumDuration);
        }),
          ...
          if (this._animateParam) {
            var n = this.axisManager.get(),
              t = this.axisManager.map(n, function (e, n) {
                return un(e, n.range, n.circular);
              });
            Ze(t, function (e, t) {
              return n[t] === e;
            }) || this.eventManager.triggerChange(t, n, e, !!e),
              (this._animateParam = null),
              this._raf && ((i = this._raf), Ge(i)),
              (this._raf = null),
              this.eventManager.triggerAnimationEnd(!!(null == e ? void 0 : e.event));
          }
          var i;
        }),
        (n.getEventInfo = function () {
          return this._animateParam && this._animateParam.input && this._animateParam.inputEvent
            ? { input: this._animateParam.input, event: this._animateParam.inputEvent }
            : null;
        }),
        (n.restore = function (e) {
          ...
          this.stopAnimation(), this.animateTo(t, this.getDuration(n, t), e);
        }),
        (n.animationEnd = function () {
          var e = this.getEventInfo();
          this._animateParam = null;
          var n = this.axisManager.filter(this.axisManager.get(), function (e, n) {
            return sn(e, n.range, n.circular);
          });
          Object.keys(n).length > 0 &&
            ...
            this.axisManager.isOutside() ? this.restore(e) : this.finish(!!e);
        }),
        (n.finish = function (e) {
        ...
        (n.getUserControl = function (e) {
          ...
          return (
            ...
            (n.duration = yn(n.duration, this._options.minimumDuration, this._options.maximumDuration)),
            n
          );
        }),
        ...
        (n.setTo = function (e, n) {
          ...
          if (Ke(e, i)) return this;
          this.interruptManager.setInterrupt(!0);
          var r = qe(e, function (e, n) {
            return i[n] !== e;
          });
          return Object.keys(r).length
            ? ((r = this.axisManager.map(r, function (e, n) {
                var t = n.range,
                  i = n.circular;
                return i && (i[0] || i[1]) ? e : on(e, t, i);
              })),
              Ke(r, i) || (n > 0 ? this.animateTo(r, n) : (this.stopAnimation(), this.eventManager.triggerChange(r), this.finish(!1))),
              this)
            : this;
        }),
        (n.setBy = function (e, n) {
          return (
            void 0 === n && (n = 0),
            this.setTo(
              Ue(this.axisManager.get(Object.keys(e)), function (n, t) {
                return n + e[t];
              }),
              n,
            )
        ...
        (n._createAnimationParam = function (e, n, t) {
          ...
          return {
            depaPos: i,
            destPos: r,
            duration: yn(n, this._options.minimumDuration, this._options.maximumDuration),
        ...
        (n._animateLoop = function (e, n) {
          var t = this;
          if (e.duration) {
            this._animateParam = ke(ke({}, e), { startTime: new Date().getTime() });
            var i = Ue(e.destPos, function (e) {
                return e;
              }),
              ...
              o = function () {
                ...
                var e = t._animateParam,
                  a = t._getNextState(r),
                  s = !t.eventManager.triggerChange(a.pos, r.pos);
                if (((r = a), a.finished))
                  return (
                    (e.destPos = t._getFinalPos(e.destPos, i)),
                    Ke(e.destPos, t.axisManager.get(Object.keys(e.destPos))) || t.eventManager.triggerChange(e.destPos, a.pos),
                    void n()
                  );
                s ? t.finish(!1) : (t._raf = Be(o));
              };
            o();
        ...
        (n._getRoundUnit = function (e, n) {
          ...
          if (!i) {
            ...
            (t = Math.max(en(o.range[0]), en(o.range[1]), en(e))), (r = 1 / Math.pow(10, t));
          }
          return r || i;
        }),
        e
      ...
      return (
        ...
        (t.updateAnimation = function (e) {
          ...
          if (n) {
            ...
            if ((null == e ? void 0 : e.restart) || r <= t) this.setTo(i, r - t);
            else {
              if (null == e ? void 0 : e.destPos) {
                var o = this.axisManager.get();
                (this._initialEasingPer = this._prevEasingPer), (n.delta = this.axisManager.getDelta(o, i)), (n.destPos = i);
              }
              if (null == e ? void 0 : e.duration) {
                var a = (t + this._durationOffset) / n.duration;
                (this._durationOffset = a * r - t), (n.duration = r);
              }
            }
          }
        }),
        ...
        (t._getNextState = function (e) {
          var n = this,
            ...
            a = (new Date().getTime() - t.startTime + this._durationOffset) / t.duration,
            s = this._easing(a),
            u = this.axisManager.map(i, function (e, u, l) {
              var c = a >= 1 ? r[l] : e + (t.delta[l] * (s - n._prevEasingPer)) / (1 - n._initialEasingPer),
                h = un(c, u.range, u.circular);
              if (c !== h) {
          ...
          return (this._prevEasingPer = s), { pos: u, easingPer: s, finished: s >= 1 };
        }),
    ...
    xn = (function (e) {
      function n(n, t, i) {
        void 0 === n && (n = {}), void 0 === t && (t = {}), void 0 === i && (i = null);
        ...
        return (
          ...
          (r.interruptManager = new rn(r.options)),
          (r.axisManager = new ln(r.axis)),
          (r.eventManager = new tn(r)),
          (r.animationManager = new Pn(r)),
          (r.inputObserver = new bn(r)),
      ...
      return (
        ...
        (t.disconnect = function (e) {
          if (e) {
            ...
            n >= 0 && (this._inputs[n].disconnect(), this._inputs.splice(n, 1));
          } else
        ...
        (t.setTo = function (e, n) {
          return void 0 === n && (n = 0), this.animationManager.setTo(e, n), this;
        }),
        (t.setBy = function (e, n) {
          return void 0 === n && (n = 0), this.animationManager.setBy(e, n), this;
        }),
    ...
    wn = (function () {
        ...
        (this.axes = []),
          ...
          (this._forceRelease = function () {
            var e = t._activeEvent,
              n = e.prevEvent;
            t._detachWindowEvent(e), e.onRelease(), t._observer.release(t, n, [0, 0]);
          }),
          (this.element = Fe(e)),
          (this.options = ke(
            {
      ...
      return (
        (n.mapAxes = function (e) {
          var n = !!e[0],
            t = !!e[1];
          (this._direction = n && t ? 30 : n ? 6 : t ? Se : 1), (this.axes = e);
        }),
        (n.connect = function (e) {
          return (
            this._activeEvent && (this._detachElementEvent(), this._detachWindowEvent(this._activeEvent)),
            this._attachElementEvent(e),
            (this._originalCssProps = (function (e, n, t) {
              var i,
                r = (((i = {})[1] = 'auto'), (i[30] = 'none'), (i[24] = 'pan-x'), (i[6] = 'pan-y'), i),
                o = {};
              if (e && e.style) {
                var a = n.touchAction ? n.touchAction : r[t],
                  s = ke(ke({}, Ve), { 'touch-action': 'none' === e.style['touch-action'] ? 'none' : a });
                Object.keys(s).forEach(function (n) {
                  (o[n] = e.style[n]), (e.style[n] = s[n]);
                });
              }
              return o;
        ...
        (n._onPanstart = function (e) {
          ...
          if (t && this._enabled && !(n.getTouches(e) > 1) && !1 !== t.srcEvent.cancelable) {
            var i = this.options.iOSEdgeSwipeThreshold;
            this._observer.hold(this, t),
              (this._atRightEdge = Le && t.center.x > window.innerWidth - i),
          ...
          if (i && this._enabled && !(t.getTouches(e) > 1)) {
            var r = this.options,
              ...
              s = (function (e, n) {
                ...
                var t = Math.abs(e);
                return t > n && t < 180 - n ? Se : 6;
              })(i.angle, this.options.thresholdAngle);
            if (!a || i.srcEvent.cancelable) {
              if (t.prevEvent && Le) {
                if (i.center.x < 0) return void this._forceRelease();
                this._atRightEdge &&
              ...
              var u = this._applyScale([i.offsetX, i.offsetY], [On(6, this._direction, s), On(Se, this._direction, s)]),
                l = u.some(function (e) {
                  return 0 !== e;
                });
              l && (!1 !== i.srcEvent.cancelable && i.srcEvent.preventDefault(), i.srcEvent.stopPropagation()),
                (i.preventSystemEvent = l),
                l && this._observer.change(this, i, mn(this.axes, u)),
                (t.prevEvent = i);
        ...
        (n._onPanend = function (e) {
          var n = this._activeEvent;
          if ((n.onEventEnd(e), this._enabled && 0 === n.getTouches(e))) {
            this._detachWindowEvent(n), clearTimeout(this._rightEdgeTimer);
            var t = n.prevEvent,
              i = this._applyScale(
                [Math.abs(t.velocityX) * (t.offsetX < 0 ? -1 : 1), Math.abs(t.velocityY) * (t.offsetY < 0 ? -1 : 1)],
                [On(6, this._direction), On(Se, this._direction)],
              );
        ...
        (n._attachWindowEvent = function (e) {
          ...
          null == e ||
            e.move.forEach(function (e) {
              window.addEventListener(e, n._onPanmove, { passive: !1 });
            }),
            null == e ||
              e.end.forEach(function (e) {
                window.addEventListener(e, n._onPanend, { passive: !1 });
              });
        }),
        ...
        (n._attachElementEvent = function (e) {
          var n = this,
            t = (function (e) {
              ...
              return (
                ...
                i ? new vn() : n && t ? new _n() : n ? new pn() : t ? new gn() : null
              );
          ...
          t &&
            ...
            t.start.forEach(function (e) {
              var t;
              null === (t = n.element) || void 0 === t || t.addEventListener(e, n._onPanstart);
            }),
            t.move.forEach(function (e) {
              var t;
              null === (t = n.element) || void 0 === t || t.addEventListener(e, function () {});
            }));
        }),
        (n._detachElementEvent = function () {
          ...
          null == n ||
            n.start.forEach(function (n) {
              var t;
              null === (t = e.element) || void 0 === t || t.removeEventListener(n, e._onPanstart);
            }),
            null == n ||
              n.move.forEach(function (n) {
                var t;
                null === (t = e.element) || void 0 === t || t.removeEventListener(n, function () {});
              }),
            (this._enabled = !1),
            (this._observer = null);
        }),
        (n._applyScale = function (e, n) {
          ...
          return n[0] && (t[0] = e[0] * i[0]), n[1] && (t[1] = e[1] * i[1]), t;
        }),
        e
      );
    })(),
    Tn = xn,
    Rn = { HOLD: 'hold', CHANGE: 'change', RELEASE: 'release', ANIMATION_END: 'animationEnd', FINISH: 'finish' },
    In = 'flick';
  !(function (e) {
    (e[(e.IDLE = 0)] = 'IDLE'),
  ...
  var An = (function () {
        ...
        (n._moveToChangedPosition = function (e) {
          ...
          if (r) {
            ...
            var o = n.camera,
              a = o.position,
              s = t.pos.flick,
              u = n.circularEnabled ? J(s, o.range.min, o.range.max) : s;
            o.lookAt(u);
            var l = new g(A.MOVE, { isTrusted: t.isTrusted, holding: this.holding, direction: U(0, t.delta.flick), axesEvent: t });
            n.trigger(l), l.isCanceled() && (o.lookAt(a), i(We.DISABLED));
          }
        }),
        e
      );
      ...
      return (
        ...
        (i.onHold = function (e) {
          var n = e.flicking,
            t = e.axesEvent,
            i = e.transitTo;
          if (n.renderer.panelCount <= 0) i(We.DISABLED);
          else {
            var r = new g(A.HOLD_START, { axesEvent: t });
            n.trigger(r), r.isCanceled() ? i(We.DISABLED) : i(We.HOLDING);
          }
        }),
        (i.onChange = function (e) {
          var n = e.flicking,
            ...
            o = new g(A.MOVE_START, { isTrusted: t.isTrusted, holding: this.holding, direction: U(r.start, r.end), axesEvent: t });
          n.trigger(o), o.isCanceled() ? i(We.DISABLED) : i(We.ANIMATING).onChange(e);
        }),
        t
      );
    })(An),
    kn = (function (e) {
      function t() {
        var n = (null !== e && e.apply(this, arguments)) || this;
        return (n.holding = !0), (n.animating = !1), (n._releaseEvent = null), n;
      }
      n(t, e);
      var i = t.prototype;
      return (
        (i.onChange = function (e) {
          var n = e.flicking,
            ...
            a = new g(A.MOVE_START, { isTrusted: t.isTrusted, holding: this.holding, direction: U(0, -o), axesEvent: t });
          n.trigger(a), a.isCanceled() ? i(We.DISABLED) : i(We.DRAGGING).onChange(e);
        }),
        (i.onRelease = function (e) {
          var n = e.flicking,
            t = e.axesEvent,
            i = e.transitTo;
          if ((n.trigger(new g(A.HOLD_END, { axesEvent: t })), 0 !== t.delta.flick))
            return t.setTo({ flick: n.camera.position }, 0), void i(We.IDLE);
        ...
        (i.onFinish = function (e) {
          var n,
            t,
            i = e.flicking;
          if (((0, e.transitTo)(We.IDLE), this._releaseEvent)) {
            var r,
            ...
            var u = i.renderer.panels,
              l = null;
            try {
              for (var c = o(u), h = c.next(); !h.done; h = c.next()) {
                var f = h.value;
                if (f.contains(r)) {
                  l = f;
                  break;
            ...
            if (l) {
              var d = i.camera.position,
                p = l.position;
              i.trigger(new g(A.SELECT, { index: l.index, panel: l, direction: U(d, p) }));
            }
          }
        }),
        t
      ...
      return (
        ...
        (i.onRelease = function (e) {
          var n,
            ...
            i = e.axesEvent,
            r = e.transitTo;
          if ((t.trigger(new g(A.HOLD_END, { axesEvent: i })), t.renderer.panelCount <= 0)) r(We.IDLE);
          else {
            r(We.ANIMATING);
            var o = t.control,
              a = i.destPos.flick,
            ...
            try {
              ...
              r(We.IDLE), i.setTo((((n = {}).flick = t.camera.position), n), 0);
            }
          }
        }),
        t
      ...
      return (
        (i.onHold = function (e) {
          var n = e.flicking,
            ...
            r = this._targetPanel,
            o = n.control;
          (this._delta = 0), n.control.updateInput(), n.changeOnHold && r && o.setActive(r, o.activePanel, t.isTrusted);
          var a = new g(A.HOLD_START, { axesEvent: t });
          n.trigger(a), a.isCanceled() ? i(We.DISABLED) : i(We.DRAGGING);
        }),
        (i.onChange = function (e) {
          this._moveToChangedPosition(e);
        }),
        (i.onFinish = function (e) {
          ...
          i(We.IDLE), n.trigger(new g(A.MOVE_END, { isTrusted: t.isTrusted, direction: U(o.start, o.end), axesEvent: t }));
      ...
      function e() {
        ...
        (this._onAxesHold = function () {
          ...
          (this._onAxesChange = function () {
            var n;
            e._dragged = !!(null === (n = e._panInput) || void 0 === n ? void 0 : n.isEnabled());
          }),
          (this._preventClickWhenDragged = function (n) {
            e._dragged && (n.preventDefault(), n.stopPropagation()), (e._dragged = !1);
          }),
          this._resetInternalValues(),
          (this._stateMachine = new Dn());
      }
      var n = e.prototype;
      return (
        ...
        Object.defineProperty(n, 'controlParams', {
          get: function () {
            ...
            var n = e.axis.flick;
            return { range: { min: n.range[0], max: n.range[1] }, circular: n.circular[0], position: this.position };
          },
          enumerable: !1,
          configurable: !0,
        }),
        Object.defineProperty(n, 'enabled', {
          get: function () {
            var e, n;
            return null !== (n = null === (e = this._panInput) || void 0 === e ? void 0 : e.isEnabled()) && void 0 !== n && n;
          },
          enumerable: !1,
          configurable: !0,
        }),
        Object.defineProperty(n, 'position', {
          get: function () {
            var e, n;
            return null !== (n = null === (e = this._axes) || void 0 === e ? void 0 : e.get([In]).flick) && void 0 !== n ? n : 0;
          },
          enumerable: !1,
          configurable: !0,
        }),
        Object.defineProperty(n, 'range', {
          get: function () {
            var e, n;
            return null !== (n = null === (e = this._axes) || void 0 === e ? void 0 : e.axis.flick.range) && void 0 !== n ? n : [0, 0];
          },
          enumerable: !1,
          configurable: !0,
        }),
        Object.defineProperty(n, 'bounce', {
          get: function () {
            var e;
            return null === (e = this._axes) || void 0 === e ? void 0 : e.axis.flick.bounce;
          },
          enumerable: !1,
          configurable: !0,
        }),
        (n.init = function (e) {
          var n,
            t = this;
          (this._flicking = e),
            (this._axes = new Tn((((n = {}).flick = { range: [0, 0], circular: !1, bounce: [0, 0] }), n), {
              deceleration: e.deceleration,
              interruptable: e.interruptable,
              nested: e.nested,
              easing: e.easing,
            })),
            (this._panInput = new wn(e.viewport.element, {
          ...
          var i = this._axes;
          i.connect(e.horizontal ? [In, ''] : ['', In], this._panInput);
          var r = function (n) {
            var r = Rn[n];
            i.on(r, function (n) {
              t._stateMachine.fire(r, { flicking: e, axesEvent: n });
            });
          };
          for (var o in Rn) r(o);
          return this;
        ...
        (n.destroy = function () {
          var e;
          this._axes && (this.removePreventClickHandler(), this._axes.destroy()),
            null === (e = this._panInput) || void 0 === e || e.destroy(),
            this._resetInternalValues();
        }),
        (n.enable = function () {
          var e;
        ...
        (n.update = function (e) {
          ...
          return (
            ...
            (o.bounce = G(t.bounce, i.size)),
            r.axisManager.set((((n = {}).flick = e.position), n)),
            this
          );
        }),
        (n.addPreventClickHandler = function () {
          var e = H(this._flicking),
            n = this._axes,
            t = e.camera.element;
          return (
            n.on(Rn.HOLD, this._onAxesHold),
            n.on(Rn.CHANGE, this._onAxesChange),
            t.addEventListener('click', this._preventClickWhenDragged, !0),
            this
          );
        }),
        (n.removePreventClickHandler = function () {
          var e = H(this._flicking),
            ...
            t = e.camera.element;
          return (
            n.off(Rn.HOLD, this._onAxesHold),
            n.off(Rn.CHANGE, this._onAxesChange),
            t.removeEventListener('click', this._preventClickWhenDragged, !0),
            this
          );
        }),
        (n.animateTo = function (e, n, t) {
          ...
          if (!a) return Promise.reject(new le(b, p.NOT_ATTACHED_TO_FLICKING));
          var u = a.get([In]).flick;
          if (u === e)
            return (
              (c = H(this._flicking)).camera.lookAt(e),
              s.targetPanel &&
                c.control.setActive(
                  s.targetPanel,
                  c.control.activePanel,
                  null !== (r = null == t ? void 0 : t.isTrusted) && void 0 !== r && r,
                ),
              Promise.resolve()
            );
          ...
          var l = function () {
            var i, r;
            a.once(Rn.FINISH, function () {
              o._animatingContext = { start: 0, end: 0, offset: 0 };
            }),
              t ? t.setTo((((i = {}).flick = e), i), n) : a.setTo((((r = {}).flick = e), r), n);
          };
          if (0 === n) {
            var c,
              h = (c = H(this._flicking)).camera;
            l();
            var f = c.circularEnabled ? J(e, h.range.min, h.range.max) : e;
            return a.axisManager.set((((i = {}).flick = f), i)), Promise.resolve();
          }
          return new Promise(function (e, n) {
            var t = function () {
              ...
              i = function () {
                a.off(Rn.FINISH, t), n(new le(w, p.ANIMATION_INTERRUPTED));
              };
            a.once(Rn.FINISH, t), a.once(Rn.HOLD, i), l();
          });
        }),
    ...
    Ln = (function () {
      function e() {
        (this._flicking = null), (this._controller = new jn()), (this._activePanel = null);
      }
      var n = e.prototype;
      return (
        ...
        Object.defineProperty(n, 'activeIndex', {
          get: function () {
            var e, n;
            return null !== (n = null === (e = this._activePanel) || void 0 === e ? void 0 : e.index) && void 0 !== n ? n : -1;
          },
          enumerable: !1,
          configurable: !0,
        }),
          ...
          return i(this, void 0, void 0, function () {
            ...
            return r(this, function (r) {
              return (
                ...
                e.removed || !u
                  ? [2, Promise.reject(new le(P(e.position), p.POSITION_NOT_REACHABLE))]
                  : (i.canReach(e)
                      ? n.circularEnabled &&
                        ((l = this._controller.position),
                        (c = i.rangeDiff),
                        (h = [o, o + c, o - c].filter(function (e) {
                          return a === k.NONE || (a === k.PREV ? e <= l : e >= l);
                        })),
                        (o = h.reduce(function (e, n) {
                          return Math.abs(l - n) < Math.abs(l - e) ? n : e;
                        }, 1 / 0)))
                      : ((o = u.position), (e = u.panel)),
                    this._triggerIndexChangeEvent(e, e.position, s),
                    [2, this._animateToPosition({ position: o, duration: t, newActivePanel: e, axesEvent: s })])
              );
            });
          });
        }),
            ...
            e !== n
              ? r.trigger(
                  new g(A.CHANGED, {
                    index: e.index,
                    panel: e,
                    prevIndex: null !== (i = null == n ? void 0 : n.index) && void 0 !== i ? i : -1,
                    prevPanel: n,
                    isTrusted: t,
                    direction: n ? U(n.position, e.position) : k.NONE,
                  }),
                )
              : r.trigger(new g(A.RESTORED, { isTrusted: t }));
        }),
        (n._triggerIndexChangeEvent = function (e, n, t) {
          var i,
            r = H(this._flicking),
            o = e !== this._activePanel ? A.WILL_CHANGE : A.WILL_RESTORE,
            a = r.camera,
            s = this._activePanel,
            u = new g(o, {
              index: e.index,
              ...
              direction: U(null !== (i = null == s ? void 0 : s.position) && void 0 !== i ? i : a.position, n),
            });
          if ((r.trigger(u), u.isCanceled())) throw new le(O, p.STOP_CALLED_BY_USER);
        }),
                ...
                t <= 0
                  ...
                  : [
                      ...
                      s()
                        ...
                        .catch(function (e) {
                          if (!(a && e instanceof le && e.code === p.ANIMATION_INTERRUPTED)) throw e;
                        }),
                    ]
              );
            });
    ...
    Vn = (function (e) {
      ...
      return (
        ...
        (i.moveToPosition = function (e, n, t) {
          var i = H(this._flicking),
            r = i.camera,
            o = r.findActiveAnchor(),
            a = r.findNearestAnchor(r.position),
            s = this._controller.state;
          if (!o || !a) return Promise.reject(new le(P(e), p.POSITION_NOT_REACHABLE));
          var u,
            l = this._calcSnapThreshold(e, o),
            c = i.animating ? s.delta : e - r.position,
            h = Math.abs(c),
            f = t && 0 !== t.delta.flick ? Math.abs(t.delta.flick) : h;
          if (f >= l && f > 0) u = this._findSnappedAnchor(e, a);
          else {
            if (!(h >= i.threshold && h > 0)) return this.moveToPanel(o.panel, { duration: n, axesEvent: t });
            u = this._findAdjacentAnchor(e, c, a);
          }
          return (
        ...
        (i._findSnappedAnchor = function (e, n) {
          var t = H(this._flicking),
            i = t.camera,
            r = this._count,
            o = i.position,
            a = i.clampToReachablePosition(e),
            s = i.findAnchorIncludePosition(a);
          if (!n || !s) throw new le(P(e), p.POSITION_NOT_REACHABLE);
          if (!isFinite(r)) return s;
          var u = t.panelCount,
            l = i.anchorPoints,
            c = Math.sign(e - o) * Math.floor(Math.abs(e - o) / i.rangeDiff);
          (e > o && s.index < n.index) || (s.position > n.position && s.index === n.index)
            ? (c += 1)
            : ((e < o && s.index > n.index) || (s.position < n.position && s.index === n.index)) && (c -= 1);
          var h = c * u,
            f = s.index + h;
          if (Math.abs(f - n.index) <= r) {
            var d = l[s.index];
            return new zn({ index: d.index, position: d.position + c * i.rangeDiff, panel: d.panel });
          }
          if (t.circularEnabled) {
            var g = l[oe(n.index + Math.sign(e - o) * r, u)],
              v = Math.floor(r / u);
            return (
              e > o && g.index < n.index ? (v += 1) : e < o && g.index > n.index && (v -= 1),
              new zn({ index: g.index, position: g.position + v * i.rangeDiff, panel: g.panel })
            );
          }
          return l[V(n.index + Math.sign(e - o) * r, 0, l.length - 1)];
        }),
        (i._findAdjacentAnchor = function (e, n, t) {
          var i,
            r = H(this._flicking).camera;
          if (r.circularEnabled) {
            var o = r.findAnchorIncludePosition(e);
            if (o && o.position !== t.position) return o;
          }
          return null !== (i = n > 0 ? r.getNextAnchor(t) : r.getPrevAnchor(t)) && void 0 !== i ? i : t;
        }),
    ...
    Hn = (function (e) {
      ...
      return (
        ...
        (i.moveToPosition = function (e, n, t) {
          var i = H(this._flicking).camera,
            r = i.clampToReachablePosition(e),
            o = i.findAnchorIncludePosition(r);
          if (!o) return Promise.reject(new le(P(e), p.POSITION_NOT_REACHABLE));
          var a = o.panel;
          return (
            a !== this._activePanel && this._triggerIndexChangeEvent(a, e, t),
            this._animateToPosition({ position: this._stopAtEdge ? r : e, duration: n, newActivePanel: a, axesEvent: t })
          );
        }),
        t
      );
      ...
      return (
        ...
        (o.updateInput = function () {
          var e,
            ...
            o = t.controlParams,
            a = this._count,
            s = r.state.animating ? (null === (e = t.findNearestAnchor(t.position)) || void 0 === e ? void 0 : e.panel) : this._activePanel;
          ...
          var u = o.range,
            ...
            f = c - a,
            d = c + a;
          f < 0 && (f = n.circularEnabled ? Z(((f + 1) % h) - 1, h) : V(f, 0, h - 1)),
            d >= h && (d = n.circularEnabled ? d % h : V(d, 0, h - 1));
          var g = i.panels[f],
            p = i.panels[d],
          ...
          return (
            ...
            _ < l && (_ += t.rangeDiff),
            (o.range = { min: v, max: _ }),
            o.circular && (o.position < v && (o.position += t.rangeDiff), o.position > _ && (o.position -= t.rangeDiff)),
            (o.circular = !1),
            r.update(o),
        ...
        (o.moveToPosition = function (e, n, t) {
          var i = H(this._flicking),
            ...
            s = this._indexRange,
            u = r.range,
            l = this._controller.state,
            c = V(r.clampToReachablePosition(e), a[0], a[1]),
            h = r.findAnchorIncludePosition(c);
          if (!h || !o) return Promise.reject(new le(P(e), p.POSITION_NOT_REACHABLE));
          var f,
            d,
            g = o.position,
            v = i.animating ? l.delta : e - r.position,
            _ = Math.abs(v) >= i.threshold,
            m = e > g ? r.getNextAnchor(h) : r.getPrevAnchor(h),
            b = r.anchorPoints,
            y = b[0],
            E = b[b.length - 1],
            x = e <= u.min && re(y.panel.index, s.min, s.max),
            O = e >= u.max && re(E.panel.index, s.min, s.max),
            w = m && (s.min <= s.max ? re(m.index, s.min, s.max) : m.index >= s.min || m.index <= s.max);
          if (x || O) {
            var T = e < u.min ? y : E;
            (d = T.panel), (f = T.position);
          } else
            _ && h.position !== o.position
              ? ((d = h.panel), (f = h.position))
              : _ && w
              ? ((d = m.panel), (f = m.position))
              : ((f = r.clampToReachablePosition(o.position)), (d = o));
          return (
            this._triggerIndexChangeEvent(d, e, t), this._animateToPosition({ position: f, duration: n, newActivePanel: d, axesEvent: t })
          );
        }),
      ...
      return (
        (n.getAnchors = function () {
          return this._flicking.renderer.panels.map(function (e, n) {
            return new zn({ index: n, position: e.position, panel: e });
          });
        }),
        (n.findAnchorIncludePosition = function (e) {
          return this._flicking.camera.anchorPoints
            ...
            .reduce(function (n, t) {
              return n && Math.abs(n.position - e) < Math.abs(t.position - e) ? n : t;
            }, null);
        }),
    ...
    Xn = (function (e) {
      ...
      return (
        ...
        (i.getRange = function () {
          ...
          return {
            min: null !== (e = null == i ? void 0 : i.position) && void 0 !== e ? e : 0,
            max: null !== (n = null == r ? void 0 : r.position) && void 0 !== n ? n : 0,
          };
        }),
        t
      );
    ...
    Yn = (function (e) {
      ...
      return (
        ...
        (i.getRange = function () {
          ...
          var n = e[0],
            t = e[e.length - 1];
          return { min: n.range.min - n.margin.prev, max: t.range.max + t.margin.next };
        }),
        ...
        (i.findNearestAnchor = function (e) {
          ...
          for (var i = n.range, r = 1 / 0, o = -1, a = 0; a < t.length; a++) {
            var s = t[a],
              u = Math.min(Math.abs(s.position - e), Math.abs(s.position - i.min + i.max - e), Math.abs(e - i.min + i.max - s.position));
            u < r && ((r = u), (o = a));
          }
          return t[o];
        }),
        (i.findAnchorIncludePosition = function (n) {
          ...
          if (a > 0 && (n === i.min || n === i.max)) {
            var l = [
              u,
              new zn({ index: 0, position: r[0].position + o, panel: r[0].panel }),
              new zn({ index: a - 1, position: r[a - 1].position - o, panel: r[a - 1].panel }),
            ].filter(function (e) {
              return !!e;
            });
          ...
          if (n < i.min) {
            ...
            return new zn({ index: u.index, position: u.position + o * c, panel: u.panel });
          }
          if (n > i.max) {
        ...
        (i.getCircularOffset = function () {
          ...
          var n = e.panels.filter(function (e) {
            ...
            t = n.filter(function (e) {
              return e.toggleDirection === k.PREV;
            }),
            i = n.filter(function (e) {
              return e.toggleDirection === k.NEXT;
            });
          return this._calcPanelAreaSum(t) - this._calcPanelAreaSum(i);
        }),
          ...
          if (r.length > 0) {
            var o = r[0].position !== i.min,
              ...
              u = r.map(function (e, n) {
                return new zn({ index: n + s, position: e.position, panel: e });
              });
            return (
              o && u.splice(0, 0, new zn({ index: 0, position: i.min, panel: t[r[0].index - 1] })),
              a && u.push(new zn({ index: u.length, position: i.max, panel: t[r[r.length - 1].index + 1] })),
              u
            );
          }
          if (i.min !== i.max) {
            var l = this._findNearestPanel(i.min, t),
              ...
              h = c.next();
            return [new zn({ index: 0, position: i.min, panel: c }), new zn({ index: 1, position: i.max, panel: h })];
          }
          return [new zn({ index: 0, position: i.min, panel: this._findNearestPanel(i.min, t) })];
        }),
        (i.findAnchorIncludePosition = function (n) {
          var t = this._flicking.camera,
            i = t.range,
    ...
    Un = (function () {
      function e(e, n) {
        ...
        (this._checkTranslateSupport = function () {
          ...
          try {
            for (
              var a = o(['webkitTransform', 'msTransform', 'MozTransform', 'OTransform', 'transform']), s = a.next();
              !s.done;
              s = a.next()
            ) {
              var u = s.value;
          ...
          if (!r) throw new le(x, p.TRANSFORM_NOT_SUPPORTED);
          t._transform = r;
        }),
          (this._flicking = e),
          this._resetInternalValues(),
      ...
      return (
        ...
        Object.defineProperty(n, 'progress', {
          get: function () {
            ...
            if (n < r) {
              ...
              return h > r && (h -= l), i.index - 1 + ne(n, h, r);
            }
            var f = i.next(),
              d = f ? f.position + f.offset : u + o[1];
            return d < r && (d += l), i.index + ne(n, r, d);
          },
          enumerable: !1,
          configurable: !0,
        }),
        ...
        (n.init = function () {
          ...
          return (
            z(e.firstElementChild, 'First element child of the viewport element'),
        ...
        (n.getPrevAnchor = function (e) {
          if (this._circularEnabled && 0 === e.index) {
            var n = this._anchors,
              t = this.rangeDiff,
              i = n[n.length - 1];
            return new zn({ index: i.index, position: i.position - t, panel: i.panel });
          }
        ...
        (n.findActiveAnchor = function () {
          var e = H(this._flicking).control.activeIndex;
        ...
        (n.updateRange = function () {
          var e = H(this._flicking).renderer.panels;
          return (
            this._updateMode(),
        ...
        (n.updateAlignPos = function () {
          ...
          return (this._alignPos = B(n, this.size)), this;
        }),
        ...
        (n.updateAdaptiveHeight = function () {
          ...
          e.horizontal && e.adaptive && n && e.viewport.setSize({ height: n.height });
        }),
        ...
        (n.resetNeedPanelHistory = function () {
          return (this._needPanelTriggered = { prev: !1, next: !1 }), this;
        }),
        (n.applyTransform = function () {
          var e = this._el,
            n = H(this._flicking);
          if (n.renderer.rendering) return this;
          var t = this._position - this._alignPos - this._offset + this._circularOffset;
          return (e.style[this._transform] = n.horizontal ? 'translate(' + -t + 'px)' : 'translate(0, ' + -t + 'px)'), this;
        }),
        (n._resetInternalValues = function () {
          (this._position = 0),
            (this._alignPos = 0),
        ...
        (n._refreshVisiblePanels = function () {
          ...
          (r.length > 0 || o.length > 0) &&
            n.renderer.render().then(function () {
              n.trigger(new g(A.VISIBLE_CHANGE, { added: r, removed: o, visiblePanels: t }));
            });
        }),
        (n._checkNeedPanel = function () {
          var e = this._needPanelTriggered;
          if (!e.prev || !e.next) {
            var n = H(this._flicking),
              t = n.renderer.panels;
            if (t.length <= 0)
              return (
                e.prev || (n.trigger(new g(A.NEED_PANEL, { direction: k.PREV })), (e.prev = !0)),
                void (e.next || (n.trigger(new g(A.NEED_PANEL, { direction: k.NEXT })), (e.next = !0)))
              );
            var i = this._position,
              ...
              l = t[0],
              c = t[t.length - 1];
            if (!e.prev) (s <= l.range.min + a || i <= o.min + a) && (n.trigger(new g(A.NEED_PANEL, { direction: k.PREV })), (e.prev = !0));
            if (!e.next) (u >= c.range.max - a || i >= o.max - a) && (n.trigger(new g(A.NEED_PANEL, { direction: k.NEXT })), (e.next = !0));
          }
        }),
        (n._checkReachEnd = function (e, n) {
          var t = H(this._flicking),
            ...
            o = n > i.min && n < i.max;
          if (r && !o) {
            var a = n <= i.min ? k.PREV : k.NEXT;
            t.trigger(new g(A.REACH_EDGE, { direction: a }));
          }
        }),
        (n._updateMode = function () {
          ...
          if (e.circular) {
            ...
            if (t) this._mode = n;
              ...
              this._mode = i === N.BOUND ? new Wn(e) : new Xn(e);
            }
            this._circularEnabled = t;
          } else this._mode = e.bound ? new Wn(e) : new Xn(e);
        }),
    ...
    qn = { __proto__: null, Camera: Un, LinearCameraMode: Xn, CircularCameraMode: Yn, BoundCameraMode: Wn },
    Zn = function (e, n) {
      return (
        (Zn =
          Object.setPrototypeOf ||
  ...
  function Kn(e, n) {
    ...
    Zn(e, n), (e.prototype = null === n ? Object.create(n) : ((t.prototype = n.prototype), new t()));
  }
  var Qn = function () {
    return (
      (Qn =
  ...
  var Jn = 'undefined' != typeof window,
    $n = Jn ? window.navigator.userAgent : '',
    et = !!Jn && !!('getComputedStyle' in window),
    nt = /MSIE|Trident|Windows Phone|Edge/.test($n),
    tt = !!Jn && !!('addEventListener' in document),
    it = 'width',
    rt = 'height';
  function ot(e, n) {
  ...
  function ut(e, n, t) {
    tt ? e.addEventListener(n, t, !1) : e.attachEvent ? e.attachEvent('on' + n, t) : (e['on' + n] = t);
  }
  function lt(e, n, t) {
    e.removeEventListener ? e.removeEventListener(n, t, !1) : e.detachEvent ? e.detachEvent('on' + n, t) : (e['on' + n] = null);
  }
  function ct(e, n) {
    ...
    return (
      parseFloat(
        t ||
          (function (e) {
            return (et ? window.getComputedStyle(e) : e.currentStyle) || {};
          })(e)[n.toLowerCase()],
      ) || 0
    );
  }
    ...
    var i = at(
      e.querySelectorAll(
        (function () {
          ...
          ['[' + t + 'skip] [' + t + 'width]'],
          n.map(function (e) {
            return ['[' + t + 'skip] ' + e, e + '[' + t + 'skip]', '[' + t + 'width] ' + e].join(', ');
          }),
        ).join(', '),
      ),
    );
    return at(e.querySelectorAll('[' + t + 'width], ' + n.join(', '))).filter(function (e) {
      return -1 === i.indexOf(e);
    });
  }
  var ft = [];
  function dt(e, n) {
    !ft.length && ut(window, 'resize', pt), (e.__PREFIX__ = n), ft.push(e), gt(e);
  }
  function gt(e, n) {
    void 0 === n && (n = 'data-');
    var t = e.__PREFIX__ || n,
      i = parseInt(ot(e, '' + t + it), 10) || 0,
      r = parseInt(ot(e, '' + t + rt), 10) || 0;
    if (ot(e, t + 'fixed') === rt) {
      var o = ct(e, 'Height') || r;
  ...
  var vt = (function (e) {
      function n(n, t) {
        ...
        (i.isReady = !1),
          ...
          (i.options = Qn({ prefix: 'data-' }, t)),
          (i.element = n);
        var r = i.options.prefix;
        return (
          (i.hasDataSize = (function (e, n) {
            return void 0 === n && (n = 'data-'), !!e.getAttribute(n + 'width');
          })(n, r)),
          (i.isSkip = (function (e, n) {
            return void 0 === n && (n = 'data-'), !!e.getAttribute(n + 'skip');
          })(n, r)),
          (i.hasLoading = st(n)),
          i
        );
      ...
      return (
        (t.check = function () {
          return this.isSkip || !this.checkElement()
            ...
            : (this.hasDataSize && dt(this.element, this.options.prefix),
        ...
        (t.removeAutoSizer = function () {
          if (this.hasDataSize) {
            ...
            !(function (e, n) {
              ...
              if (!(t < 0)) {
                var i = ot(e, n + 'fixed');
                delete e.__PREFIX__, (e.style[i === rt ? it : rt] = ''), ft.splice(t, 1), !ft.length && lt(window, 'resize', pt);
              }
            })(this.element, e);
          }
        }),
        ...
        (t.onPreReady = function () {
          this.isPreReady ||
            ((this.isPreReady = !0), this.trigger('preReady', { element: this.element, hasLoading: this.hasLoading, isSkip: this.isSkip }));
        }),
        (t.onReady = function (e) {
          this.isReady ||
            ...
            this.removeAutoSizer(),
            (this.isReady = !0),
            this.trigger('ready', { element: this.element, withPreReady: e, hasLoading: this.hasLoading, isSkip: this.isSkip }));
        }),
    ...
    _t = (function (e) {
      ...
      return (
        ...
        (t.check = function () {
          return this.isSkip
            ? (this.onAlreadyReady(!0), !1)
            : (this.hasDataSize ? (dt(this.element, this.options.prefix), this.onAlreadyPreReady()) : this.trigger('requestChildren'), !0);
        }),
    ...
    mt = (function (e) {
      function n(n) {
        ...
        return (
          ...
          (t.isPreReadyOver = !0),
          (t.elementInfos = []),
          (t.options = Qn({ loaders: {}, prefix: 'data-' }, n)),
          t
        );
      }
      Kn(n, e);
      ...
      return (
        (t.check = function (e) {
          ...
          this.clear(),
            (this.elementInfos = at(e).map(function (e, i) {
              ...
              return (
                ...
                r
                  ...
                  .on('preReady', function (e) {
                    ...
                    n.onPreReadyElement(i), r && n.onPreReady();
                  })
                  .on('ready', function (e) {
                    ...
                    var s = t && n.checkPreReady(i),
                      u = n.checkReady(i);
                    t && n.onPreReadyElement(i), n.onReadyElement(i), s && n.onPreReady(), u && n.onReady();
                  }),
                { loader: r, element: e, hasLoading: !1, hasError: !1, isPreReady: !1, isReady: !1, isSkip: !1 }
              );
            }));
        ...
        (t.getLoader = function (e, n) {
          ...
          var a = new _t(e, n),
            s = at(e.querySelectorAll(o.join(', ')));
          a.setHasLoading(
            s.some(function (e) {
              return st(e);
            }),
        ...
        (t.onReady = function () {
          this.trigger('ready', { errorCount: this.getErrorCount(), totalErrorCount: this.totalErrorCount, totalCount: this.totalCount });
        }),
    ...
    bt = (function (e) {
      ...
      return (
        ...
        (n.prototype.checkElement = function () {
          ...
          if (e.complete) {
            if (n) return e.naturalWidth || this.onAlreadyError(e), !1;
            this.onAlreadyPreReady();
          }
          return this.addEvents(), nt && e.setAttribute('src', n), !0;
        }),
        (n.EVENTS = ['load', 'error']),
        n
      );
    ...
    yt = (function (e) {
      ...
      return (
        ...
        (n.prototype.checkElement = function () {
          var e = this.element;
          return !(e.readyState >= 1) && (e.error ? (this.onAlreadyError(e), !1) : (this.addEvents(), !0));
        }),
    ...
    Et = (function (e) {
      function n(n) {
        return void 0 === n && (n = {}), e.call(this, Qn({ loaders: { img: bt, video: yt } }, n)) || this;
      }
      return Kn(n, e), n;
    })(mt),
    Pt = (function () {
      function e(e) {
        var n = e.align,
          t = void 0 === n ? C.CENTER : n,
          i = e.strategy;
        (this._flicking = null), (this._panels = []), (this._rendering = !1), (this._align = t), (this._strategy = i);
      }
      var n = e.prototype;
      return (
        ...
        (n.batchInsert = function () {
          ...
          return t.length <= 0 ? [] : (this.updateAfterPanelChange(t, []), t);
        }),
        (n.batchInsertDefer = function () {
          ...
          var i = this._panels,
            ...
            u = n.reduce(function (n, t) {
              var u,
                l = Z(t.index, i.length),
                c = i.slice(l),
                h = t.elements.map(function (n, t) {
                  return e._createPanel(n, { index: l + t, align: a, flicking: r });
                });
              if (
                (i.splice.apply(i, s([l, 0], h)),
                t.hasDOMInElements && e._insertPanelElements(h, null !== (u = c[0]) && void 0 !== u ? u : null),
                r.panelsPerView > 0)
              ) {
                var f = o || h[0].resize();
              ...
              return (
                c.forEach(function (e) {
                  e.increaseIndex(h.length), e.updatePosition();
                }),
                s(n, h)
              );
            }, []);
          ...
          var i = this._panels,
            ...
            u = n.reduce(function (n, t) {
              ...
              return h.length <= 0
                ? []
                : (c.forEach(function (e) {
                    e.decreaseIndex(h.length), e.updatePosition();
                  }),
                  t.hasDOMInElements && e._removePanelElements(h),
                  h.forEach(function (e) {
                    return e.destroy();
                  }),
                  K(h, a) && o.resetActive(),
          ...
          if ((this._updateCameraAndControl(), this.render(), !i.animating))
            if (!u || u.removed)
              if (a.length <= 0) r.lookAt(0);
                ...
                var l = null !== (t = null == u ? void 0 : u.index) && void 0 !== t ? t : 0;
                l > a.length - 1 && (l = a.length - 1), o.moveToPanel(a[l], { duration: 0 }).catch(function () {});
              }
            else o.moveToPanel(u, { duration: 0 }).catch(function () {});
          i.camera.updateOffset(),
            (e.length > 0 || n.length > 0) &&
              (i.trigger(new g(A.PANEL_CHANGE, { added: e, removed: n })), this.checkPanelContentsReady(s(e, n)));
        }),
        (n.checkPanelContentsReady = function (e) {
          var n = this,
            ...
            r = this._panels;
          if (i && !t.virtualEnabled) {
            if (
              !(
                (e = e.filter(function (e) {
                  return (function (e) {
                    return e.element && !!e.element.querySelector('img, video');
                  })(e);
                })).length <= 0
              )
            ) {
                ...
                o.on('readyElement', function (i) {
                  if (n._flicking) {
                    var a = e[i.index],
                      s = t.camera,
                      u = t.control,
                      l = u.activePanel ? s.getProgressInPanel(u.activePanel) : 0;
                    (a.loading = !1),
                      a.resize(),
                      r.slice(a.index + 1).forEach(function (e) {
                        return e.updatePosition();
                      }),
                      t.initialized &&
                        (s.updateRange(), s.updateOffset(), s.updateAnchors(), u.animating || (u.updatePosition(l), u.updateInput()));
                  } else o.destroy();
                }),
                o.on('preReady', function (e) {
                  n._flicking && n.render(), e.readyCount === e.totalCount && o.destroy();
                }),
                o.on('ready', function () {
        ...
        (n._updateCameraAndControl = function () {
          var e = H(this._flicking),
            n = e.camera,
            t = e.control;
          n.updateRange(), n.updateOffset(), n.updateAnchors(), n.resetNeedPanelHistory(), t.updateInput();
        }),
        (n._showOnlyVisiblePanels = function (e) {
          ...
          n.forEach(function (n) {
            n.index in t || n.loading ? n.markForShow() : e.holding || n.markForHide();
          });
        }),
        (n._updatePanelSizeByGrid = function (e, n) {
          var t = H(this._flicking),
            i = t.panelsPerView;
          if (i <= 0) throw new le(y('panelsPerView', i), p.WRONG_OPTION);
          if (!(n.length <= 0)) {
            var r = (t.camera.size - (e.margin.prev + e.margin.next) * (i - 1)) / i,
              o = t.horizontal ? { width: r } : { height: r },
              a = { size: r, height: e.height, margin: e.margin };
            t.noPanelStyleOverride || this._strategy.updatePanelSizes(t, o),
        ...
        (n._removeAllChildsFromCamera = function () {
          for (var e = H(this._flicking).camera.element; e.firstChild; ) e.removeChild(e.firstChild);
        }),
        (n._insertPanelElements = function (e, n) {
          void 0 === n && (n = null);
          var t = H(this._flicking).camera.element,
        ...
        (n._removePanelElements = function (e) {
          var n = H(this._flicking).camera.element;
          e.forEach(function (e) {
    ...
    xt = (function (e) {
      ...
      return (
        ...
        (o._collectPanels = function () {
          var e = H(this._flicking),
            n = e.camera;
          this._removeAllTextNodes(), (this._panels = this._strategy.collectPanels(e, n.children));
        }),
        ...
        (o._resetPanelElementOrder = function () {
          var e = H(this._flicking),
            n = e.camera.element,
            t = this._strategy.getRenderingElementsByOrder(e).reverse();
        ...
        (o._removeAllTextNodes = function () {
          var e = H(this._flicking).camera.element;
          F(e.childNodes).forEach(function (n) {
    ...
    Ot = (function (e) {
      ...
      n(t, e);
      var i = t.prototype;
      return (i._removePanelElements = function (e) {}), (i._removeAllChildsFromCamera = function () {}), t;
    })(Pt),
    wt = (function () {
      function e(e) {
        var n = e.index,
      ...
      return (
        ...
        Object.defineProperty(n, 'offset', {
          get: function () {
            ...
            return e !== k.NONE && this._toggled ? (e === k.PREV ? -n : n) : 0;
          },
          enumerable: !1,
          configurable: !0,
        }),
        ...
        Object.defineProperty(n, 'visibleRatio', {
          get: function () {
            ...
            var a = n;
            return i.min > r && (a -= i.min - r), i.max < o && (a -= o - i.max), a / n;
          },
          enumerable: !1,
          configurable: !0,
        }),
        ...
        (n.resize = function (e) {
          ...
          if (e) (this._size = e.size), (this._margin = t({}, e.margin)), (this._height = e.height);
          else {
            var r = te(n);
            (this._size = i ? n.offsetWidth : n.offsetHeight),
              (this._margin = i
                ? { prev: parseFloat(r.marginLeft || '0'), next: parseFloat(r.marginRight || '0') }
                : { prev: parseFloat(r.marginTop || '0'), next: parseFloat(r.marginBottom || '0') }),
              (this._height = i ? n.offsetHeight : this._size);
          }
          return this.updatePosition(), this._updateAlignPos(), this;
        }),
        (n.setSize = function (e) {
          return ie(this.element, e), this;
        }),
        (n.contains = function (e) {
          var n;
          return !!(null === (n = this.element) || void 0 === n ? void 0 : n.contains(e));
        }),
        (n.destroy = function () {
        ...
        (n.includeRange = function (e, n, t) {
          ...
          var i = this._margin,
            r = this.range;
          return t && ((r.min -= i.prev), (r.max += i.next)), n >= r.min && e <= r.max;
        }),
        ...
        (n.prev = function () {
          var e = this._index,
            ...
            t = n.renderer,
            i = t.panelCount;
          return 1 === i ? null : n.circularEnabled ? t.getPanel(0 === e ? i - 1 : e - 1) : t.getPanel(e - 1);
        }),
        (n.next = function () {
          var e = this._index,
            n = this._flicking,
            t = n.renderer,
            i = t.panelCount;
          return 1 === i ? null : n.circularEnabled ? t.getPanel(e === i - 1 ? 0 : e + 1) : t.getPanel(e + 1);
        }),
        ...
        (n.toggle = function (e, n) {
          ...
          if (t === k.NONE || n === e) return !1;
          var r = this._toggled;
          return (
            n > e ? i >= e && i <= n && (this._toggled = t === k.NEXT) : i <= e && i >= n && (this._toggled = t !== k.NEXT),
            r !== this._toggled
          );
        }),
        (n.updateCircularToggleDirection = function () {
          var e = this._flicking;
          if (!e.circularEnabled) return (this._toggleDirection = k.NONE), (this._toggled = !1), this;
          var n = e.camera,
            t = n.range,
            i = n.alignPosition,
            r = n.visibleRange,
          ...
          return (
            (this._toggled = !1),
            u
              ? ((this._toggleDirection = k.PREV),
                (this._togglePosition = this.range.max + t.min - t.max + i),
                this.toggle(1 / 0, n.position))
              : l
              ? ((this._toggleDirection = k.NEXT), (this._togglePosition = this.range.min + t.max - o + i), this.toggle(-1 / 0, n.position))
              : ((this._toggleDirection = k.NONE), (this._togglePosition = 0)),
            this
          );
        }),
        (n._updateAlignPos = function () {
          this._alignPos = B(this._align, this._size);
        }),
      ...
      return (
        ...
        (n.getRenderingIndexesByOrder = function (e) {
          var n = e.renderer.panels.filter(function (e) {
            ...
            t = n.filter(function (e) {
              return e.toggled && e.toggleDirection === k.PREV;
            }),
            i = n.filter(function (e) {
              return e.toggled && e.toggleDirection === k.NEXT;
            });
          return s(
            t,
            n.filter(function (e) {
        ...
        (n.collectPanels = function (e, n) {
          var t = this,
            i = W(e.renderer.align);
          return n.map(function (n, r) {
            return new wt({ index: r, elementProvider: new t._providerCtor(n), align: i, flicking: e });
          });
        }),
        (n.createPanel = function (e, n) {
          return new wt(t(t({}, n), { elementProvider: new this._providerCtor(e) }));
        }),
        ...
        (n._showOnlyVisiblePanels = function (e) {
          ...
          n.forEach(function (n) {
            n.index in i || n.loading ? n.markForShow() : e.holding || n.markForHide();
          }),
            t.updateOffset();
        }),
        e
    ...
    Rt = (function (e) {
      function t(n) {
        ...
        return n.elementProvider.init(t), (t._elProvider = n.elementProvider), (t._cachedInnerHTML = null), t;
      }
      n(t, e);
      var i = t.prototype;
      return (
        ...
        Object.defineProperty(i, 'elementIndex', {
          get: function () {
            var e = this._flicking,
              ...
              t = e.panelCount,
              i = this._index;
            return this._toggled && (i = this._toggleDirection === k.NEXT ? i + t : i - t), oe(i, n);
          },
          enumerable: !1,
          configurable: !0,
        }),
        ...
        (i.render = function () {
          ...
          r !== i.innerHTML && ((i.innerHTML = r), t && this.cacheRenderResult(r));
        }),
        (i.increaseIndex = function (n) {
          return this.uncacheRenderResult(), e.prototype.increaseIndex.call(this, n);
        }),
        (i.decreaseIndex = function (n) {
          return this.uncacheRenderResult(), e.prototype.decreaseIndex.call(this, n);
        }),
        t
      );
    })(wt),
      ...
      return (
        ...
        (n.getRenderingIndexesByOrder = function (e) {
          var n = e.virtual,
            i = s(e.visiblePanels)
              ...
              .sort(function (e, n) {
                return e.position + e.offset - (n.position + n.offset);
              });
          return i.length <= 0
        ...
        (n.updateRenderingPanels = function (e) {
          ...
          n.forEach(function (e) {
            e.index in i || e.loading ? e.markForShow() : e.markForHide();
          }),
            t.updateOffset();
        }),
        (n.collectPanels = function (e) {
          var n = W(e.renderer.align);
          return ae(e.virtual.initialPanelCount).map(function (t) {
            return new Rt({ index: t, elementProvider: new de(e), align: n, flicking: e });
          });
        }),
        (n.createPanel = function (e, n) {
          return new Rt(t(t({}, n), { elementProvider: new de(n.flicking) }));
        }),
        (n.updatePanelSizes = function (e, n) {
          e.virtual.elements.forEach(function (e) {
            ie(e.nativeElement, n);
          }),
            e.panels.forEach(function (e) {
              return e.setSize(n);
            });
    ...
    At = {
      ...
      VanillaRenderer: xt,
      ExternalRenderer: Ot,
      NormalRenderingStrategy: Tt,
      VirtualRenderingStrategy: It,
    },
    Ct = (function (e) {
      function o(n, t) {
        var i = void 0 === t ? {} : t,
          r = i.align,
          o = void 0 === r ? C.CENTER : r,
          a = i.defaultIndex,
          s = void 0 === a ? 0 : a,
          u = i.horizontal,
          l = void 0 === u || u,
          ...
          m = i.panelsPerView,
          b = void 0 === m ? -1 : m,
          y = i.noPanelStyleOverride,
          E = void 0 !== y && y,
          P = i.resizeOnContentsReady,
          x = void 0 !== P && P,
          O = i.nested,
          w = void 0 !== O && O,
          T = i.needPanelThreshold,
          R = void 0 === T ? 0 : T,
          I = i.preventEventsBeforeInit,
          A = void 0 === I || I,
          k = i.deceleration,
          M = void 0 === k ? 0.0075 : k,
          S = i.duration,
          ...
          U = i.bounce,
          q = void 0 === U ? '20%' : U,
          Z = i.iOSEdgeSwipeThreshold,
          K = void 0 === Z ? 30 : Z,
          Q = i.preventClickOnDrag,
          J = void 0 === Q || Q,
          $ = i.disableOnInit,
          ee = void 0 !== $ && $,
          ne = i.changeOnHold,
          te = void 0 !== ne && ne,
          ie = i.renderOnlyVisible,
          re = void 0 !== ie && ie,
          oe = i.virtual,
          ae = void 0 === oe ? null : oe,
          se = i.autoInit,
          ue = void 0 === se || se,
          le = i.autoResize,
          fe = void 0 === le || le,
          de = i.useResizeObserver,
          pe = void 0 === de || de,
          ve = i.resizeDebounce,
          _e = void 0 === ve ? 0 : ve,
          me = i.maxResizeDebounce,
          be = void 0 === me ? 100 : me,
          ye = i.externalRenderer,
          Ee = void 0 === ye ? null : ye,
          Pe = i.renderExternal,
          xe = void 0 === Pe ? null : Pe,
          Oe = e.call(this) || this;
        return (
          (Oe._initialized = !1),
          (Oe._plugins = []),
          ...
          (Oe._horizontal = l),
          (Oe._circular = h),
          (Oe._circularFallback = d),
          (Oe._bound = p),
          (Oe._adaptive = _),
          (Oe._panelsPerView = b),
          (Oe._noPanelStyleOverride = E),
          (Oe._resizeOnContentsReady = x),
          (Oe._nested = w),
          (Oe._virtual = ae),
          (Oe._needPanelThreshold = R),
          (Oe._preventEventsBeforeInit = A),
          (Oe._deceleration = M),
          (Oe._duration = D),
          (Oe._easing = z),
          (Oe._inputType = H),
          ...
          (Oe._interruptable = W),
          (Oe._bounce = q),
          (Oe._iOSEdgeSwipeThreshold = K),
          (Oe._preventClickOnDrag = J),
          (Oe._disableOnInit = ee),
          (Oe._changeOnHold = te),
          (Oe._renderOnlyVisible = re),
          (Oe._autoInit = ue),
          (Oe._autoResize = fe),
          (Oe._useResizeObserver = pe),
          (Oe._resizeDebounce = _e),
          (Oe._maxResizeDebounce = be),
          (Oe._externalRenderer = Ee),
          (Oe._renderExternal = xe),
          (Oe._viewport = new ce(L(n))),
          (Oe._autoResizer = new he(Oe)),
          (Oe._renderer = Oe._createRenderer()),
          (Oe._camera = Oe._createCamera()),
          (Oe._control = Oe._createControl()),
          (Oe._virtualManager = new ge(Oe, ae)),
          Oe._autoInit && Oe.init(),
          Oe
        );
      }
      n(o, e);
      ...
      return (
        ...
        Object.defineProperty(a, 'preventClickOnDrag', {
          ...
          set: function (e) {
            if (e !== this._preventClickOnDrag) {
              ...
              e ? n.addPreventClickHandler() : n.removePreventClickHandler(), (this._preventClickOnDrag = e);
            }
          },
          enumerable: !1,
          configurable: !0,
        ...
        Object.defineProperty(a, 'changeOnHold', {
          get: function () {
            return this._changeOnHold;
          },
          set: function (e) {
            this._changeOnHold = e;
          },
          enumerable: !1,
          configurable: !0,
        }),
        ...
        Object.defineProperty(a, 'autoResize', {
          ...
          set: function (e) {
            (this._autoResize = e), e ? this._autoResizer.enable() : this._autoResizer.disable();
          },
          enumerable: !1,
          configurable: !0,
        }),
        ...
        (a.init = function () {
          ...
          return (
            ...
            this._preventClickOnDrag && i.controller.addPreventClickHandler(),
        ...
        (a.prev = function (e) {
          ...
          return (
            ...
            this.moveTo(
              null !==
                (i =
                  null === (t = null === (n = this._control.activePanel) || void 0 === n ? void 0 : n.prev()) || void 0 === t
                    ? void 0
                    : t.index) && void 0 !== i
                ? i
                : -1,
        ...
        (a.next = function (e) {
          ...
          return (
            ...
            this.moveTo(
              null !==
                (i =
                  null === (t = null === (n = this._control.activePanel) || void 0 === n ? void 0 : n.next()) || void 0 === t
                    ? void 0
                    : t.index) && void 0 !== i
                ? i
        ...
        (a.moveTo = function (e, n, t) {
          void 0 === n && (n = this._duration), void 0 === t && (t = k.NONE);
          var i = this._renderer,
            r = i.panelCount,
            o = i.getPanel(e);
          return o
            ? this._control.animating
              ? Promise.reject(new le(T, p.ANIMATION_ALREADY_PLAYING))
              : this._control.moveToPanel(o, { duration: n, direction: t })
            : Promise.reject(new le(E(e, 0, r - 1), p.INDEX_OUT_OF_RANGE));
        }),
        ...
        (a.getStatus = function (e) {
          var n,
            ...
            f = this._camera,
            d = {
              panels: (h ? this.visiblePanels : this.panels).map(function (e) {
                var n = { index: e.index };
                return l && (n.html = e.element.outerHTML), n;
              }),
            };
          if ((o && (d.index = this.index), s)) {
            var g = f.findNearestAnchor(f.position);
            g && (d.position = { panel: g.panel.index, progressInPanel: f.getProgressInPanel(g.panel) });
          }
          if (h) {
            var p = this.visiblePanels;
            d.visibleOffset = null !== (t = null === (n = p[0]) || void 0 === n ? void 0 : n.index) && void 0 !== t ? t : 0;
          }
          return d;
        }),
        (a.setStatus = function (e) {
          var n;
          if (!this._initialized) throw new le(I, p.NOT_INITIALIZED);
          var t = e.index,
            i = e.position,
            r = e.visibleOffset,
            o = e.panels,
            ...
            s = this._control;
          if (
            ((null === (n = o[0]) || void 0 === n ? void 0 : n.html) &&
              !this._renderExternal &&
              (a.batchRemove({ index: 0, deleteCount: this.panels.length, hasDOMInElements: !0 }),
              a.batchInsert({
                index: 0,
                elements: q(
                  o.map(function (e) {
          ...
          if (i && this._moveType === M.FREE_SCROLL) {
            var l = i.panel,
              c = i.progressInPanel,
        ...
        (a.addPlugins = function () {
          for (var e, n = this, t = [], i = 0; i < arguments.length; i++) t[i] = arguments[i];
          return (
            this._initialized &&
              t.forEach(function (e) {
                return e.init(n);
        ...
        (a.removePlugins = function () {
          ...
          return (
            n.forEach(function (n) {
              var t = ee(e._plugins, function (e) {
                return e === n;
              });
              ...
              switch (r.label) {
                case 0:
                  return (
                    ...
                    this.trigger(new g(A.BEFORE_RESIZE, { width: a, height: s, element: e.element })),
                    e.resize(),
                ...
                case 2:
                  return (
                    r.sent(),
                    i.animating || (i.updatePosition(u), i.updateInput()),
                    (l = e.width),
                    (c = e.height),
                    (h = l !== a || c !== s),
                    this.trigger(
                      new g(A.AFTER_RESIZE, {
                        width: e.width,
                        height: e.height,
        ...
        (a.insert = function (e, n) {
          if (this._renderExternal) throw new le(R, p.NOT_ALLOWED_IN_FRAMEWORK);
          return this._renderer.batchInsert({ index: e, elements: q(n), hasDOMInElements: !0 });
        }),
        (a.remove = function (e, n) {
          if ((void 0 === n && (n = 1), this._renderExternal)) throw new le(R, p.NOT_ALLOWED_IN_FRAMEWORK);
          return this._renderer.batchRemove({ index: e, deleteCount: n, hasDOMInElements: !0 });
        }),
        (a._createControl = function () {
          var e,
            n = this._moveType,
            t = Object.keys(M).map(function (e) {
              return M[e];
            }),
            i = Array.isArray(n) ? n[0] : n,
            r = Array.isArray(n) && null !== (e = n[1]) && void 0 !== e ? e : {};
          if (!K(t, i)) throw new le(y('moveType', JSON.stringify(n)), p.WRONG_OPTION);
          switch (i) {
            case M.SNAP:
              return new Vn(r);
            case M.FREE_SCROLL:
        ...
        (a._createCamera = function () {
          return (
            this._circular && this._bound && console.warn('"circular" and "bound" option cannot be used together, ignoring bound.'),
            new Un(this, { align: this._align })
          );
        }),
        (a._createRenderer = function () {
          ...
          return (
            this._virtual &&
              this._panelsPerView <= 0 &&
              console.warn('"virtual" and "panelsPerView" option should be used together, ignoring virtual.'),
            e || (this._renderExternal ? this._createExternalRenderer() : this._createVanillaRenderer())
          );
        }),
        ...
        (a._createVanillaRenderer = function () {
          ...
          return new xt({ align: this._align, strategy: e ? new It() : new Tt({ providerCtor: fe }) });
        }),
        (a._moveToInitialPanel = function () {
          ...
          if (i) {
            ...
            if ((n.setActive(i, null, !1), !r)) throw new le(P(i.position), p.POSITION_NOT_REACHABLE);
            var o = i.position;
            t.canReach(i) || (o = r.position), t.lookAt(o), n.updateInput(), t.updateOffset();
          }
        }),
        (a._initialResize = function () {
          var e = this._viewport,
            ...
            t = this._camera,
            i = this._control;
          this.trigger(new g(A.BEFORE_RESIZE, { width: 0, height: 0, element: e.element })),
            e.resize(),
            n.updatePanelSize(),
            t.updateAlignPos(),
            t.updateRange(),
          ...
          var r = e.width,
            ...
            a = 0 !== r || 0 !== o;
          this.trigger(
            new g(A.AFTER_RESIZE, { width: e.width, height: e.height, prev: { width: 0, height: 0 }, sizeChanged: a, element: e.element }),
          );
        }),
        (o.VERSION = '4.8.1'),
        o
    ...
    kt = function (e, n, t, i, r) {
      return e.batchInsertDefer.apply(
        e,
        s(
          n.added.slice(i, r).map(function (e, n) {
            return { index: e, elements: [t[n]], hasDOMInElements: !1 };
          }),
        ),
      );
    },
    Mt = function (e, n, t) {
      ...
      return e.batchRemoveDefer({ index: n, deleteCount: i.length, hasDOMInElements: !1 });
    },
    St = function (e) {
    ...
    jt = {
      ...
      withFlickingMethods: function (e, n) {
        [d.prototype, Ct.prototype].forEach(function (t) {
          Object.getOwnPropertyNames(t)
            .filter(function (n) {
              return !e[n] && 0 !== n.indexOf('_') && 'constructor' !== n;
            })
            .forEach(function (i) {
              ...
              if (r.value)
                Object.defineProperty(e, i, {
                  value: function () {
                    ...
                    return (e = r.value).call.apply(e, s([this[n]], t));
                  },
                });
              else {
                var o = {};
                r.get &&
                  (o.get = function () {
                    var e,
                      t = this[n];
                    return t && (null === (e = r.get) || void 0 === e ? void 0 : e.call(t));
                  }),
                  r.set &&
                    (o.set = function () {
                      for (var e, t = [], i = 0; i < arguments.length; i++) t[i] = arguments[i];
                      return null === (e = r.set) || void 0 === e ? void 0 : e.call.apply(e, s([this[n]], t));
                    }),
      ...
      sync: function (e, n, t) {
        ...
        if (n.removed.length > 0) {
          ...
          n.removed.forEach(function (e) {
            c < 0 && (c = e), h >= 0 && e !== h - 1 ? (l.push.apply(l, s(Mt(i, h, c + 1))), (c = e), (h = e)) : (h = e), o.splice(e, 1);
          }),
            l.push.apply(l, s(Mt(i, h, c + 1)));
        }
        if (
          ...
          n.added.forEach(function (e, t) {
            f < 0 && (f = t), d >= 0 && e !== d + 1 ? (u.push.apply(u, s(kt(i, n, g, f, t + 1))), (f = -1), (d = -1)) : (d = e);
          }),
            f >= 0 && u.push.apply(u, s(kt(i, n, g, f)));
        }
        (n.added.length > 0 || n.removed.length > 0) && i.updateAfterPanelChange(u, l);
      },
      ...
      getDefaultCameraTransform: function (e, n, t) {
        void 0 === e && (e = C.CENTER), void 0 === n && (n = !0);
        var i = St(e),
          r = Nt(e);
        if (null == r) return '';
        var o = 'calc(' + i + ' - (' + (t || '0px') + ' * ' + r.percentage + ') - ' + r.absolute + 'px)';
  ...
  return (
    j(Ct, {
      ...
      AnchorPoint: zn,
      VirtualManager: ge,
      VanillaElementProvider: fe,
      VirtualElementProvider: de,
      Panel: wt,
      VirtualPanel: Rt,
    }),
    j(Ct, qn),
